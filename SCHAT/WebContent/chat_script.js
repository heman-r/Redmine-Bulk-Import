var wsUri = getServerRootUri() + "/SCHAT/chat-server";
var currentUsername = "";
var chatWebsocket;
var single_group="all";
var Val;
...
function signin() {
    ...
    if (retVal !="") {
        ...
        chatWebsocket = new WebSocket(wsUri, "SCHAT");
...
function button_sendMessage() {
    ...
    if (chatString.length > 0) {
        chatWebsocket.send("ctmsg" + currentUsername + ":" + chatString + ":" +single_group);
